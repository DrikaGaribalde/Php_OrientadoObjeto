				...
				<div id ="projeto">Projetos <br> Especiais</div>
					<div id="web_descricaoProjeto">
						...
						<span>
							...
							Preocupando-se com as novas tendências no Design de Fachadas, a Speedy Graph disponibiliza aos seus clientes revestimentos de alta classe (retro-fit – termo utilizado no que consiste em revitalizar e atualizar as construções para aumentar a vida útil do imóvel, através da incorporação de modernas tecnologias e materiais de qualidade avançada – fundamental para reconquistar a valorização da unidade). Dentro de uma concepção arquitetônica arrojada, de primeiríssima categoria, beleza, durabilidade e versatilidade.
O Alumínio Composto, responde com modernidade e praticidade à criatividade de arquitetos, designers e projetistas.
						</span>
					</div>
