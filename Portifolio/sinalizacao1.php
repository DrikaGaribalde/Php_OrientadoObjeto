...
<body>
	...
	<div id = "web1">
		...
		<div id = "web_cliente">
			<div id="fundo_sinaliacao">
				<div id ="sinalizacao">Sinalização</div>
					<div id="web_descricaoSinalizacao">
						
						<span>
							
							Utilizamos uma combinação variada de substratos, aliando projeto personalizado, impressão digital e usinagem 3D, aplicados a materiais como MDF, acrílico, PVC expandido, ACM, entre outros.
							O resultado é um projeto diferenciado e exclusivo para a sua empresa.
						</span>
					</div>
					<div id="mostrar_logo_sinaliacao">
						<?php

							//Arquivo de conexao com o banco de dados
							include "conexao.php";
							//
							$_pagi_sql ="SELECT  servico.cod_servico, servico.cod_categoria, servico.foto FROM servico WHERE (((servico.cod_categoria=2)))order by servico.foto";
							//
							$_pagi_cuantos = 4; //número de registros a serem mostrados em cada página
